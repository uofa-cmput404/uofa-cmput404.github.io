...
Also, we use GitHub "Classroom" to make sure we can keep student's assignments for one year. Keeping things for one year is U
University policy. We may need to reference back to it if grades go missing, or if there's a grade dispute, or if something happens to a TA, or if there's a plagiarism concern.
