Title: Course Outline Fall 2023
date: 2023-09-06
tags: outline, policy
authors: Hazel Victoria Campbell
status: published
summary: University of Alberta <br> CMPUT 404 - Web Applications and Architecture <br> LEC-A1 <br> Fall 2023

----

# University of Alberta <br> CMPUT 404 - Web Applications and Architecture <br> LEC-A1 <br> Fall 2023

**eClass Page**: <https://eclass.srv.ualberta.ca/course/view.php?id=91562>

# Lecture

*  Monday Wednesday Friday, 1:00PM to 1:50PM, CSC B-02
...
The weekly topic schedule is likely to be updated during the term; please see [the latest version](/index.html).
...
All assignments and project parts are due at 16:00 on the due date (usually a Friday). In the labs, the TAs will explain the submission process (typically online). Late submissions will not be accepted.

Although you may program in python at home or outside the lab, your implementations will be scored based on their behavior on the supplied VM. There may be software version and screen size differences. Please make sure you have built and tested your code on the lab machines.
...
|-------------------------|------|-------------|
|Assignment 1             |5%    |Consultation |
|Assignment 2             |5%    |Consultation |
|Assignment 3             |5%    |Consultation |
|Assignment 4             |5%    |Consultation |
|Assignment 5             |5%    |Consultation |
|Participation            |10%   |Consultation |
|Labs                     |10%   |Solo Effort  |
|Project Part 0           |1%    |Teamwork     |
|Project Part 1           |10%   |Teamwork     |
|Project Part 2           |4%    |Teamwork     |
|Project Part 3           |20%   |Teamwork     |
|Final Exam               |20%   |Solo Effort  |
...
**Missed Term Work: Participation**: Half of the lowest marks for participation will be dropped when calculating the course mark. No late participation will be accepted.
Failure to participate on time for any reason will result in a mark of zero. Please note that you can miss **half** of the participation opportunities without penalty.
