...
# University of Alberta <br> CMPUT 404 - Web Applications and Architecture <br> LEC-B1 <br> Winter 2024
...
Labs and Project Parts are due at 16:00 on the date of your registered lab section in BearTracks (Monday or Wednesday). In the labs, the TAs will explain the [submission process](labs.html) (typically online). Late submissions will not be accepted for any reason.
...
For more information, see the [Percentages and Letter Grades explanation](grade_letters.html).
