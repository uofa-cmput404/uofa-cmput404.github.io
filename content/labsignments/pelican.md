...
<img id="sample-1" src="{{ SITEURL }}/{{ THEME_STATIC_DIR }}/sample-fancy-mode-1.png" alt="sample-1" width="600">

<img id="sample-2" src="{{ SITEURL }}/{{ THEME_STATIC_DIR }}/sample-minimal-mode-2.png" alt="sample-2" width="600">

<img id="sample-3" src="{{ SITEURL }}/{{ THEME_STATIC_DIR }}/sample-90s-mode-3.png" alt="sample-3" width="600">
